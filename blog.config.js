...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '菩提网络', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的小混子🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://1023.blog', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '菩提网络, 博客,C/C++', // 网站关键词 英文逗号隔开
